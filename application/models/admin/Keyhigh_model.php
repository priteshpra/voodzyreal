...
class Keyhigh_model extends CI_Model
{
    ...
    public function listData($per_page_record = 10, $page_number = 1)
    {
        ...
        $sql = "call usp_A_GetPropertyKeyhigh('" .
            $per_page_record . "' , '" .
            $page_number . "','" .
            $ProjectID .
            "')";
    ...
    function insert($data)
    {
        ...
        $sql = "call usp_A_AddPropertKeyhigh('" .
            $data['ProjectID'] . "','" .
            $data['Title'] . "','" .
            $data['CreatedBy'] . "','" .
            $data['Status'] . "','" .
    ...
    function update($data)
    {
        ...
        if ($this->session->userdata['IsAdmin'] = 1)
            ...
            $data['UserType'] = 'Employee Web';
        $data['IPAddress'] = GetIP();
        $sql = "call usp_A_EditPropertyKeyHigh('" .
            $data['PropertyKeyHighlightsID'] . "','" .
            $data['ProjectID'] . "','" .
            $data['Title'] . "','" .
            $data['CreatedBy'] . "','" .
            $data['Status'] . "','" .
    ...
    {
        $query = $this->db->query("call usp_A_GetPropertyKeyHighByID('" . $ID . "')");
        $query->next_result();
        return $query->row();
    }
    ...
    function changeStatus($data)
    {
        ...
        $data['table_name']  = "ss_propertykeyhighlights ";
        $data['field_name']  = "PropertyKeyHighlightsID";
