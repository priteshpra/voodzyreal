...
class Details_model extends CI_Model
{
    ...
    public function listData($per_page_record = 10, $page_number = 1)
    {
        ...
        $sql = "call usp_A_GetProjectDetails('" .
            $per_page_record . "' , '" .
            $page_number . "','" .
            $ProjectID .
            "')";
    ...
    function insert($data)
    {
        ...
        $sql = "call usp_A_AddPropertDetails('" .
            $data['ProjectID'] . "','" .
            $data['TotalUnits'] . "','" .
            $data['BuilderName'] . "','" .
            $data['PossessionYear'] . "','" .
    ...
    function update($data)
    {
        ...
        if ($this->session->userdata['IsAdmin'] = 1)
            ...
            $data['UserType'] = 'Employee Web';
        $data['IPAddress'] = GetIP();
        $sql = "call usp_A_EditPropertyDetails('" .
            $data['ProjectID'] . "','" .
            $data['TotalUnits'] . "','" .
            $data['BuilderName'] . "','" .
            $data['PossessionYear'] . "','" .
    ...
    {
        $query = $this->db->query("call usp_A_GetPropertyDetailsByID('" . $ID . "')");
        $query->next_result();
        return $query->row();
    }
    ...
    function changeStatus($data)
    {
        ...
        $data['table_name']  = "ss_projectdetails ";
        $data['field_name']  = "ProjectDetailsID";
