...
class Propertyfeature_model extends CI_Model
{
    ...
    public function listData($per_page_record = 10, $page_number = 1)
    {
        ...
        $sql = "call usp_A_GetPropertyFeature('" .
            $per_page_record . "' , '" .
            $page_number . "','" .
            $ProjectID .
            "')";
    ...
    function insert($data)
    {
        ...
        $sql = "call usp_A_AddPropertFeature('" .
            $data['ProjectID'] . "','" .
            $data['FeaturesID'] . "','" .
            $data['CreatedBy'] . "','" .
            $data['Status'] . "','" .
    ...
    function update($data)
    {
        ...
        if ($this->session->userdata['IsAdmin'] = 1)
            ...
            $data['UserType'] = 'Employee Web';
        $data['IPAddress'] = GetIP();
        $sql = "call usp_A_EditPropertyFeature('" .
    ...
    {
        $query = $this->db->query("call usp_A_GetPropertyFeatureByID('" . $ID . "')");
        $query->next_result();
        return $query->row();
    }
    ...
    function changeStatus($data)
    {
        ...
        $data['table_name']  = "ss_propertyfeatures ";
        $data['field_name']  = "PropertyFeaturesID";
