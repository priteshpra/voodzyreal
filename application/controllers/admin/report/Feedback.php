...
class Feedback extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/report/feedback/list', $array);
        $data['page_level_js'] = $this->load->view('admin/report/feedback/list_js', NULL, TRUE);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1)
    {
        ...
        $res['data_array'] = $this->report_model->FeedbackListData($PageSize, $CurrentPage);
        ...
        if ($res['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/feedback/ajax_listing', $res, TRUE);
    ...
    public function export_to_excel()
    {
        ...
        $array['data'] = $this->report_model->FeedbackListData(-1, 1);
        ...
        ob_end_clean();
        $filename = 'FeedbackReports.xls'; //save our workbook as this file name
