...
class totalpayment extends Admin_Controller {

    function __construct() {
        parent::__construct();
        $this->load->model('admin/report_model');
        $tmp =  $this->db->query("CALL usp_A_GetRoleModuleByID(" . $this->UserRoleID . ",54,0)");
        $tmp->next_result();
    ...
    public function index() {
        ...
        $this->load->view('admin/report/totalpayment/list', $data);
        $data['page_level_js'] = $this->load->view('admin/report/totalpayment/list_js', $data, TRUE);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1) {
        ...
        $result['data_array'] = $this->report_model->TotalPayment($PageSize, $CurrentPage);
        ...
        if ($result['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/totalpayment/ajax_listing', $result, TRUE);
    ...
    public function export_to_excel() {
        ...
        $fields = array(
            ...
            "TotalPayByCustomer"=>"TotalPayByCustomer",
            "TotalGstpsyByCustomer"=>"TotalGSTPayByCustomer",
            "RemainingAmountPayment"=>"RemainingAmountPayment",
            "RemainingGSTPayment"=>"RemainingGSTPayment"
        );

        $this->load->library('excel');
        $array['data'] = $this->report_model->TotalPayment(-1,1);
        ...
        ob_end_clean();
        $filename = 'TotalPayment.xls'; //save our workbook as this file name
