...
class Notification extends Admin_Controller {
    ...
    function __construct() {
        ...
        $tmp =  $this->db->query("CALL usp_A_GetRoleModuleByID(" . $this->UserRoleID . ",61,0)");
        $tmp->next_result();
    ...
    public function index() {
        ...
        $this->load->view('admin/report/notification/list', $data);
        $data['page_level_js'] = $this->load->view('admin/report/notification/list_js', $data, TRUE);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1) {
        ...
        $result['data_array'] = $this->report_model->NotificationData($PageSize, $CurrentPage);
        ...
        if ($result['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/notification/ajax_listing', $result, TRUE);
