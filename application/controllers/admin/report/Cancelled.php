...
class Cancelled extends Admin_Controller {
    ...
    function __construct() {
        ...
        $tmp =  $this->db->query("CALL usp_A_GetRoleModuleByID(" . $this->UserRoleID . ",43,0)");
        $tmp->next_result();
    ...
    public function index() {
        ...
        $this->load->view('admin/report/cancelled/list', $data);
        $data['page_level_js'] = $this->load->view('admin/report/cancelled/list_js', $data, TRUE);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1) {
        ...
        $result['data_array'] = $this->report_model->GetCancelledProject($PageSize, $CurrentPage);
        ...
        if ($result['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/cancelled/ajax_listing', $result, TRUE);
    ...
    public function export_to_excel() {
        ...
        $fields = array(
            ...
            "TotalGSTPayment"=>"TotalGSTPayment",
            "RefundPayment"=>"RefundPayment",
            "RefundGSTPayment"=>"RefundGSTPayment",
            "CancelFeeAmount"=>"CancelFeeAmount"
        );

        //$fields = array("SrNo", "PropertyNo", "SerialNo","CustomerFirstName","CustomerLastName","CustomerSFirstName","CustomerSLastName","PurchaseDate","Amount","GSTAmount","RemainingPayment","RemainingGSTPayment","TotalPayment","TotalGSTPayment","RefundPayment","RefundGSTPayment","CancelFeeAmount");

        $this->load->library('excel');
        $array['data'] = $this->report_model->GetCancelledProject(-1,1);
        ...
        ob_end_clean();
        $filename = 'CancelledProjects.xls'; //save our workbook as this file name
