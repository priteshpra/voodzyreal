...
class Payment extends Admin_Controller {
    ...
    public function index() {
        ...
        if($this->ProjectID == -1)
        {
            ...
            $data['Property'] = getPropertyCombobox(0,0,1,"All");
        }
        else
        {
            $data['Project'] = getProject($this->ProjectID,-1,$this->UserRoleID,0);
            $data['Property'] = getPropertyCombobox(0,$this->ProjectID,1,"All");
        }
        //$data['Project'] = getProject(0,-1,$this->UserRoleID);
        //$data['Property'] = getPropertyCombobox(0,0,1);
        $this->load->view('admin/includes/header');
        $this->load->view('admin/report/payment/list', $data);
        $data['page_level_js'] = $this->load->view('admin/report/payment/list_js', $data, TRUE);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1) {
        ...
        $result['data_array'] = $this->report_model->GetPayment($PageSize, $CurrentPage);
        ...
        if ($result['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/payment/ajax_listing', $result, TRUE);
    ...
    public function export_to_excel() {
        ...
        $array['data'] = $this->report_model->GetPayment(-1,1);
