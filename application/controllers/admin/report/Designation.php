...
class Designation extends Admin_Controller
{
    ...
    {
        parent::__construct();
        $tmp =  $this->db->query("CALL usp_A_GetRoleModuleByID(" . $this->UserRoleID . ",62,0)");
        $tmp->next_result();
    ...
    public function index()
    {
        ...
        $this->load->view('admin/report/designation/list', $res);
        $data['page_level_js'] = $this->load->view('admin/report/designation/list_js', NULL, TRUE);
        $data['footer']['add_link'] = $this->config->item('base_url') . 'admin/report/designation/add';
    ...
    public function ajax_listing($per_page_record = 10, $page_number = 1)
    {
        ...
        if ($result['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/designation/ajax_listing', $result, TRUE);
    ...
    public function export_to_excel()
    {
        ...
        ob_end_clean();
        $filename = 'VisitorDesignation.xls';
