...
class Leadtype extends Admin_Controller
{

    function __construct()
    {
        parent::__construct();
        $tmp =  $this->db->query("CALL usp_A_GetRoleModuleByID(" . $this->UserRoleID . ",65,0)");
        $tmp->next_result();
    ...
    public function index()
    {
        ...
        $this->load->view('admin/report/leadtype/list', $res);
        $data['page_level_js'] = $this->load->view('admin/report/leadtype/list_js', NULL, TRUE);
        $data['footer']['add_link'] = $this->config->item('base_url') . 'admin/report/leadtype/add';
    ...
    public function ajax_listing($per_page_record = 10, $page_number = 1)
    {
        ...
        $result['visitor'] = $this->report_model->LeadTypeFromEndDatelistData($per_page_record, $page_number);
        ...
        if ($result['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/leadtype/ajax_listing', $result, TRUE);
    ...
    public function export_to_excel()
    {
        ...
        $res['visitor'] = $this->report_model->LeadTypeFromEndDatelistData(-1, 1);
