...
class Visitorlost extends Admin_Controller
{
    ...
    public function data($FilterType)
    {
        $array = $data = array();
        ...
        $this->load->view('admin/report/visitorlost/list', $array);
        $data['page_level_js'] = $this->load->view('admin/report/visitorlost/list_js',$array,TRUE);
    ...
    public function ajax_listing($PageSize = 10, $CurrentPage = 1)
    {
        ...
        $res['data_array'] = $this->report_model->listVisitorLost($PageSize, $CurrentPage);
        ...
        if ($res['total_records'] != 0) {
            ...
            $ajax_listing = $this->load->view('admin/report/visitorlost/ajax_listing', $res, TRUE);
