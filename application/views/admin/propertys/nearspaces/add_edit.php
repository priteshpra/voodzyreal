    ...
    <div class="container">
        <div class="card-panel col s12">
            <h4 class="header m-t-0">
                <a href="<?php echo site_url('admin/sales/property/details/' . $ProjectID . '#nearbyspaces'); ?>"><strong>Near By Spaces</strong>
                </a>
            </h4>
            <div class="row">
                <form class="col s12" method="post" action="<?php echo $this->config->item('base_url'); ?>admin/sales/nearspaces/<?php echo $Page; ?>">
                    <div class="row">
                        <div class="input-field col s12 m12">
                            <input type="hidden" name="PropertyNearybyPlacesID" id="PropertyNearybyPlacesID" value="<?php echo isset($MileStone->PropertyNearybyPlacesID) ? $MileStone->PropertyNearybyPlacesID : 0; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <a href="<?php echo site_url('admin/sales/property/details/' . $ProjectID . '#nearbyspaces'); ?>" class="right close-button">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
