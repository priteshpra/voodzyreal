    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12">
          <h5 class="breadcrumbs-title"><a href="<?php echo base_url(); ?>admin/project/project"><?php echo label('msg_lbl_project');?></a></h5>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="row">
            <div class="col s12">
              <div class="row m-b-0">
                ...
                <div class="col m6 s12 center m-t-20">
                    <span><label><?php echo label('msg_lbl_project_title');?> :</label></span> &nbsp;&nbsp;
                ...
                <div class="col s12 m4 right-align list-page-right-top-icon">
                  ...
                  <i id="display_action" onclick="field_display();" class="mdi-hardware-keyboard-arrow-down tooltipped" data-position="top" data-delay="50" data-tooltip="Search Filter"></i></a>
                    ...
                    <a href="<?php echo site_url();?>admin/project/project/export_to_excel"  class="export-excel btn-floating  right waves-effect waves-light btn white-text"><i class="mdi-file-cloud-download tooltipped" data-position="top" data-delay="50" data-tooltip="Export Excel"></i></a>
				          <?php } ?>
			            <?php if(@$this->cur_module->is_insert == 1){?>
                    <a href="<?php echo $this->config->item('base_url'); ?>admin/project/project/add" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i></a>
			           <?php } ?>
                </div>
              </div>
            </div>
              ...
              <div class="search_action card-panel" style="display:none;">                                
                ...
                <div class="row m-b-0">
                  <div class="input-field col s6">
                    ...
                    <label name="Title_search" class=""><?php echo label('msg_lbl_projecttitle');?> </label>
                  </div> 
        					<div class="input-field col s6">
            ...
            <div class="table-responsive">
              <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th class="width_200"><?php echo label('msg_lbl_project_title');?></th>
                        ...
                        <th class="width_180"><?php echo label('msg_lbl_project_type');?></th>
