        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/report/payment">Payment</a></h5>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col s12">
                            <div class="search_action card-panel" style="display:none;">                                
								...
								<div class="row m-b-0">
                                    ...
                                    <div id="PropertyDiv" class="input-field col s12 m6">
                                        <?php echo $Property; ?>
                                    </div>
								</div>
                        ...
                        <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="width_200"><?php echo label('msg_lbl_amounttype')?></th>
