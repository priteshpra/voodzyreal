        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/report/birthday">Birthday</a></h5>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="search_action card-panel" style="display:none;">                                
								...
								<div class="row m-b-0">
                                    <div class="input-field col s12 m1">
                                        <input type="text" name="BirthDate" id="BirthDate" value="<?php echo date("d"); ?>" class="NumberOnly" maxlength="2" max="12">
