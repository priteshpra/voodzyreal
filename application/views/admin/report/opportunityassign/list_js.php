<script type="text/javascript">
    ...
    window.AssignStatus = "<?php echo $AssignStatus; ?>";
    window.FilterType = "<?php echo $FilterType; ?>";
    window.ReportUserID = "<?php echo $ReportUserID; ?>";
    window.EmployeeID = '-1';

    function common_ajax(current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/report/opportunityassign/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                Name: Name,
                MobileNo: MobileNo,
                Project: Project,
    ...
    $(".TableBody").on('click', '.info', function() {
        ...
        var table_name = "ss_opportunity";
        var field_name = "OpportunityID";
