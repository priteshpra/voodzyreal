        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/report/cancelled">Cancelled/Hold Projects</a></h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-panel">
                        ...
                        <div class="col s12">
                            <div class="search_action card-panel" style="display:none;">                                
								...
								<div class="row m-b-0">
                                    ...
                                    <div class="input-field col s12 m6">
                                        <label for="ProjectState"><?php echo label('msg_lbl_projectstate');?></label>
                                        <br>
                                        <input name="ProjectState" type="radio" value="1" id="yescancelled" />
                                        <label for="yescancelled"><?php echo label('msg_lbl_iscancelled');?></label>
                                        
                                        <input name="ProjectState" type="radio" value="2" id="yeshold"/>
                                        <label for="yeshold"><?php echo label('msg_lbl_ishold');?></label>

                                        <input name="ProjectState" type="radio" value="-1" id="allstate" checked="checked" />
                                        <label for="allstate"><?php echo "All";?></label>
                                    </div> 
                    ...
                    <div class="table-responsive">
                        <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th class="width_100"><?php echo label('msg_lbl_project')?></th>
                                    ...
                                    <th class="width_200"><?php echo label('msg_lbl_receivedamount')?></th>
                                    <th class="width_200"><?php echo label('msg_lbl_receivedgstamount')?></th>
                                    <th class="width_200"><?php echo label('msg_lbl_refundamount')?></th>
                                    <th class="width_200"><?php echo label('msg_lbl_refundgstamount')?></th>
                                    <th class="width_200"><?php echo label('msg_lbl_cancelfeeamount')?></th>
                                </tr>
                            </thead>
...
<!-- END CONTENT-->
<form id="exportfrm" action="<?php echo site_url('admin/report/cancelled/export_to_excel');?>" method="post">
    <input type="hidden" name="ProjectState" id="ProjectState" value="">
