<script type="text/javascript">
    ...
    window.total_page = 1;
    window.ProjectID = -1;
    window.ProjectState = -1;
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/report/cancelled/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    ProjectID: ProjectID,
    ...
    $('#button_submit').on('click', function () {
        ...
        ProjectState =  $('input[name="ProjectState"]:checked').val();  
    ...
    $("#exportfrm #ProjectState").val(ProjectState);
    $("#exportfrm").submit();
});
</script>