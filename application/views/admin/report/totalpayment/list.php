        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/report/TotalPayment">Total Payment</a></h5>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="width_200"><?php echo label('msg_lbl_total_payamount')?></th>
                                    <th class="width_200"><?php echo label('msg_lbl_total_dueamount')?></th>
                                    <th class="width_130"><?php echo label('msg_lbl_gstamount')?></th>
                                    <th class="width_200"><?php echo label('msg_lbl_total_paygst')?></th>
                                    <th class="width_200"><?php echo label('msg_lbl_total_duegstamount')?></th>
                                </tr>
                            </thead>
...
<!-- END CONTENT-->
<form id="exportfrm" action="<?php echo site_url('admin/report/TotalPayment/export_to_excel');?>" method="post">
