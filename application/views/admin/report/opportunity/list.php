        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/report/opportunity"><?php echo label('msg_lbl_opportunity'); ?></a></h5>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo label('msg_lbl_locality'); ?></th>
                                    <th><?php echo label('msg_lbl_city'); ?></th>
                                    <th class="width_200"><?php echo label('msg_lbl_type'); ?></th>
                                    <th><?php echo label('msg_lbl_msg'); ?></th>
                                    <th ><?php echo label('msg_lbl_datetime'); ?></th>
                                    <th><?php echo label('msg_lbl_vdatetime'); ?></th>
                                    <th><?php echo label('msg_lbl_subject'); ?></th>
                                    <th><?php echo label('msg_lbl_trantype'); ?></th>
                                    <th><?php echo label('msg_lbl_loginid'); ?></th> 
