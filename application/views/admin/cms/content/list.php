        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/masters/content">CMS</a></h5>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row m-b-0">
                                ...
                                <div class="col s2 right right-align">
                                    <!--                                    <a class="btn-floating waves-effect waves-light grey right">
                                                                            <i id="display_action" onClick="field_display();" class="mdi-hardware-keyboard-arrow-down"></i>
                                                                        </a>-->
                                    <div class="right">
                                        <a href="<?php echo $this->config->item('base_url'); ?>admin/masters/content/add" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="search_action card-panel" style="display:none;">                                
                                ...
                                <div class="row m-b-0">
                                    <!--  <div class="input-field col s6">
                                       <input type="text" name="contentTitle" id="contentTitle" value="" class="form-control">
                                       <label name="contentTitle" class="">content</label>
                                     </div> -->                                     
                                ...
                                <button class="btn waves-effect waves-light right" type="button" id="button_content_submit" name="button_content_submit">Submit
                                </button>
                                &nbsp;&nbsp;&nbsp;
