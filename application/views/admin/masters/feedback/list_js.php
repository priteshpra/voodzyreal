<script type="text/javascript">
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/feedback/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    Feedback: Feedback,
                    Status: Status
                },
    ...
    $(document).ready(function () {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_title_feedback');?>");
   ...
   $(".TableBody").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/feedback/changeStatus",
    ...
    $(".TableBody").on('click', '.info', function(){ 
        ...
        var id = $(this).attr('data-id');
        var table_name = "ss_feedback";
        var field_name = "FeedbackID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/feedback/getRecordInfo",
