<script type="text/javascript">
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/goods/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    GoodsName: GoodsName,
                    Status: Status
                },
    ...
    $(document).ready(function () {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_title_category');?>");
   ...
   $(".TableBody").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/goods/changeStatus",
    ...
    $(".TableBody").on('click', '.info', function(){ 
        ...
        var id = $(this).attr('data-id');
        var table_name = "ss_goods";
        var field_name = "GoodsID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/goods/getRecordInfo",
