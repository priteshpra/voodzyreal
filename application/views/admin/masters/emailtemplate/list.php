        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/masters/emailtemplate"><?php echo label('msg_lbl_title_emailtemplate');?></a></h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-panel">
                        ...
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <div class="col s12 m4 right-align list-page-right-top-icon">
                                  ...
                                  <a href="<?php echo $this->config->item('base_url'); ?>admin/masters/emailtemplate/add" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i></a>
								  <?php } ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="search_action card-panel" style="display:none;">                                
								...
								<div class="row m-b-0">
								  <div class="input-field col s12 m6">
									<input type="text" name="EmailTemplateTitle" id="EmailTemplateTitle" maxlength="50" class="form-control LetterOnly">
									<label name="EmailTemplateTitle" class=""><?php echo label('msg_lbl_emailtemplatetitle');?></label>
								  </div>
                    ...
                    <div class="table-responsive">
                        <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th class="width_250"><?php echo label('msg_lbl_emailtemplatetitle');?></th>
    								<th class="width_250"><?php echo label('msg_lbl_emailsubject');?></th>
    								<th class="actions center"><?php echo label('msg_lbl_status');?></th>
    								<th class="actions center"><?php echo label('msg_lbl_action');?></th>
                                </tr>
                            </thead>

                            <tbody id="emailtemplate_table_body">
