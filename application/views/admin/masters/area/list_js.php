<script type="text/javascript">
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/area/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    AreaName: AreaName,
                    Status: Status
                },
    ...
    $(document).ready(function () {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_title_area');?>");
   ...
   $(".TableBody").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/area/changeStatus",
    ...
    $(".TableBody").on('click', '.info', function(){ 
        ...
        var id = $(this).attr('data-id');
        var table_name = "ss_category";
        var field_name = "CategoryID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/area/getRecordInfo",
