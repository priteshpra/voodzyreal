<script type="text/javascript">
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/group/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    GroupName: GroupName,  
    ...
    $(document).ready(function () {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_title_group');?>");
 ...
 var field_name = ["GroupName"]; 
   $("#table_body").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/group/changeStatus",
    ...
    $("#table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        var id = $(this).attr('data-id');
        var table_name = "sssm_group";
        var field_name = "GroupID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/group/getRecordInfo",
