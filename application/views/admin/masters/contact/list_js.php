<script type="text/javascript">
    ...
    function common_ajax(current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/contact/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                Name: Name,
                Status: Status
            },
    ...
    $(document).ready(function() {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_title_contact'); ?>");
    ...
    $(".TableBody").on('click', '.status_change', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/contact/changeStatus",
            data: {
                id: id,
                status: status
            },
    ...
    $(".TableBody").on('click', '.info', function() {
        ...
        var id = $(this).attr('data-id');
        var table_name = "ss_contact";
        var field_name = "ContactID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/contact/getRecordInfo",
            data: {
                id: id,
