<script type="text/javascript">
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/uom/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    UOMName: UOMName,
                    Status: Status
                },
    ...
    $(document).ready(function () {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_title_uom');?>");
   ...
   $(".TableBody").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/uom/changeStatus",
    ...
    $(".TableBody").on('click', '.info', function(){ 
        ...
        var id = $(this).attr('data-id');
        var table_name = "ss_uom";
        var field_name = "UOMID";
        $.ajax({
            type: "post",
