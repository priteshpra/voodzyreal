<script type="text/javascript">
    ...
    function common_ajax(current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/campaign/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                Title: Title,
                Status: Status
            },
    ...
    $(document).ready(function() {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_title_campaign'); ?>");
    ...
    $(".TableBody").on('click', '.status_change', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/campaign/changeStatus",
            data: {
                id: id,
                status: status
            },
    ...
    $(".TableBody").on('click', '.info', function() {
        ...
        var id = $(this).attr('data-id');
        var table_name = "ss_campaign";
        var field_name = "CampaignID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/campaign/getRecordInfo",
            data: {
                id: id,
