<script type="text/javascript">
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/country/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
    ...
    $(document).ready(function () {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_country');?>");
 ...
 var field_name = ["CountryName"]; 
   $("#country_table_body").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/country/changeStatus",
    ...
    $("#country_table_body").on('click', '.info', function(){ //$(".info").on('click', function () {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/country/getRecordInfo",
