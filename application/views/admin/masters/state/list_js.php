<script type="text/javascript">
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/state/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
                    StateName: StateName,
    ...
    $(document).ready(function () {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_state');?>");
   ...
   $("#table_body").on('click', '.status_change', function()
   {
        ...
        $.ajax({
            type:"post",
            url: base_url + "admin/masters/state/changeStatus",
    ...
    $("#table_body").on('click', '.info', function(){ 
        var id = $(this).attr('data-id');
        var table_name = "sssm_state";
        var field_name = "StateID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/state/getRecordInfo",
