<script type="text/javascript">
    ...
    function common_ajax(current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/requirements/ajax_listing/" + current_page_size + "/" + total_page,
            data: {
    ...
    $(document).ready(function() {
        ...
        $("#model_title").html("<?php echo label('msg_lbl_requirement'); ?>");
    ...
    $(".TableBody").on('click', '.status_change', function() {
        ...
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/requirements/changeStatus",
            data: {
                id: id,
                status: status
            },
    ...
    $(".TableBody").on('click', '.info', function() {
        ...
        var id = $(this).attr('data-id');
        var table_name = "ss_requirementvalue";
        var field_name = "RequirementValueID";
        $.ajax({
            type: "post",
            url: base_url + "admin/masters/requirements/getRecordInfo",
            data: {
                id: id,
