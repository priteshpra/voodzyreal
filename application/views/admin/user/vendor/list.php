        ...
        <div class="container">
            <div class="row">
                <div class="col s12 m12 l12">
                    <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/user/vendor"><?php echo label('msg_lbl_title_vendor');?></a></h5>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col s12">
                            <div class="row m-b-0">
                                ...
                                <div class="col s12 m4 right-align list-page-right-top-icon">
								  ...
								  <?php }if(@$this->cur_module->is_insert == 1){?>
								  <a href="<?php echo site_url("admin/user/vendor/add");?>" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add tooltipped" data-position="top" data-delay="50" data-tooltip="Add"></i></a>
								  <?php } ?>
                                </div>
                            </div>
                        </div>
                        <form id="ExportForm" action="<?php echo site_url('admin/user/vendor/export_to_excel');?>" method="post" class="col s12 search_action p-b-20" style="display:none;"> 
                        <div class="col s12">
                            ...
                            <h4 class="header"><strong> <?php echo label('msg_lbl_search_value');?> </strong></h4>
								<div class="row m-b-0">
								  <div class="input-field col s12 m6">
									<input id="Name" name="Name" type="text" class="LetterOnly" value=""  maxlength="250" />
                                    <label for="Name"><?php echo label('msg_lbl_name')?></label>
								  </div>      
                                  <div class="input-field col s12 m6">
                                        <input id="EmailID" name="EmailID" type="text" class=""  maxlength="250" />
                                        <label for="EmailID"><?php echo label('msg_lbl_emailormobile')?></label>
                                    </div>           
                        ...
                        <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="width_180"><?php echo label('msg_lbl_vendor_businessname');?></th>
                                    <th class="width_130"><?php echo label('msg_lbl_category');?></th>
