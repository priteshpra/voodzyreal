    ...
    <div class="container">
        <div class="card-panel col s12">
            <h4 class="header m-t-0">
                <a href="<?php echo base_url('admin/user/visitor/details/' . $VisitorID . "#reminder"); ?>"><strong><?php echo label('msg_lbl_title_visitoreminder'). ' - ' . @$visit->FirstName . ' ' . @$visit->LastName; ?></strong>
                </a>
            </h4>
            <div class="row">
