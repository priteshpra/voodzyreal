                ...
                <form class="col s12" id="addStateForm" method="post" action="<?php echo $this->config->item('base_url'); ?>admin/user/visitor/<?php echo $page_name; ?>">
                    ...
                    <div class="row">
                        <div class="input-field col s12 m6">
                            ...
                            <input id="EmailID" name="EmailID" type="email" class="" value="<?php echo @$visitor->EmailID; ?>" maxlength="250" <?php /*if(isset($visitor->VisitorID)){ echo 'readonly';}else{echo '';}*/ ?> />
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input id="MobileNo" name="MobileNo" type="text" class="empty_validation_class MobileNo" value="<?php echo @$visitor->MobileNo; ?>" maxlength="15" <?php /*if(isset($visitor->VisitorID)){ echo 'readonly';}else{echo '';}*/ ?> />
