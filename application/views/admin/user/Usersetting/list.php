    ...
    <div class="container">
      <div class="row">
        <div class="col s12 m12 l12">
          <h5 class="breadcrumbs-title"><a href="<?php echo $this->config->item('base_url'); ?>admin/user/Usersetting">UserSetting</a></h5>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="card-panel">
              ...
              <div class="row m-b-0">
                ...
                <div class="col s2 right-align">
                 ...
                 <div class="right">
                    ...
                    <a href="<?php echo site_url();?>admin/user/usersetting/export_to_excel" class="export-excel btn-floating  right waves-effect waves-light btn white-text"><i class="mdi-file-cloud-download"></i></a>
                    <a href="<?php echo site_url(); ?>admin/user/Usersetting/add" class="btn-floating right waves-effect waves-light green accent-6"><i class="mdi-content-add"></i></a>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="search_action card-panel" style="display:none;">                                
                ...
                <div class="row m-b-0"> 
                  <div class="input-field col s6">
                    <input type="text" name="UserType" id="UserType" value="" class="form-control">
                    <label name="UserType" class="">USERTYPE </label>
                  </div>                                   
                ...
                <button class="btn waves-effect waves-light right" type="button" id="button_Usersetting_submit" name="button_Usersetting_submit">Submit
                </button>
                &nbsp;&nbsp;&nbsp;
          ...
          <table id="data-table-row-grouping" class="display " cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>UserType</th>
                        <th>Visitor Direct Allowed</th>
                        <th>Push Notification</th>
                        <th>Complaint Notification</th>
                        <th>Ticket Notification</th>
                        <th>Maintanance Due Notication</th>
                        <th class="center">Status</th>
                        <th class="actions center">Action</th>
                    </tr>
                </thead>

                <tbody id="Usersetting_table_body">
