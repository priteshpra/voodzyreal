<script type="text/javascript">
   ...
   $(document).ready(function () {
    ...
    function common_ajax (current_page_size, total_page) {
        $.ajax({
            type: "post",
            url: base_url + "admin/user/visitor/withoutfilterajax_listing/" + current_page_size + "/" + total_page,
            data: {
        ...
        {   
            ...
            if (VisitorID>0) {
                $.ajax({
                    ...
                    data: {FeedbackID: FeedbackID, VisitorID: VisitorID,Remarks:Remarks,ProjectID:ProjectID,FeedbackDate:FeedbackDate,Type:Type},
                    success: function (data){ 
                        common_ajax(10,1);
